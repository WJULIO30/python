...
#esta classe representa a entidade do banco
class Produto(db.Model):
    ...
    def __repr__(self):
        return f'<Produto: id: {self.id} desc: {self.descricao} preço: {self.preco} quantidade: {self.quantidade} data: {self.cadastrado}>'
